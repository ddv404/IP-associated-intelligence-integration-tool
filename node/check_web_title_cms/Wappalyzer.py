...
class WebPage:
    ...
    @classmethod
    def new_from_url(cls, url: str,my_header, my_body, my_title, **kwargs:Any) -> 'WebPage':

        return cls.new_from_response(url,my_header, my_body, my_title)

    @classmethod
    def new_from_response(cls, url,my_header, my_body, my_title) -> 'WebPage':

        return cls(url, html=my_body, headers=my_header)
