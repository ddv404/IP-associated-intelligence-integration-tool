...
regist_result = regist_tool('check_ip_addr', 'IP地理', '对IP地址进行地理位置查询', 'IP', 2)
...
ip_reg = IpRegData()
while True:
    ip_infos_result = get_check_data('check_ip_addr',2)
